(() => {
  ...
  var ConsentFlow = () => {
    ...
    function insertSettingIcon() {
      ...
      if (body.length >= 1) {
        insertCssClasses()
        body[0].innerHTML = "<div>"+consentText+"</div>"+body[0].innerHTML;
